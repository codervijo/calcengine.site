...
const meta: CalculatorMeta = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Yes for CPU-bound work. Async and non-blocking I/O reduce thread count but do not change how many CPU cycles are consumed per request. Enter the actual CPU ms burned per request from profiling data. For services where requests block threads waiting on I/O, also work out <a href="/calculators/littles-law-calculator">how many requests sit in flight at once</a> to size your thread pool correctly alongside CPU.',
    },
    {
  ...
  relatedSlugs: ['qps-calculator', 'thread-pool-size-calculator', 'littles-law-calculator', 'latency-budget-calculator'],
};
